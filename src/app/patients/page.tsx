...
export default async function PatientsPage() {
  ...
  const rows: PatientWithTreatment[] = (patients ?? []).map((p) => {
    ...
    const days = status !== 'discharged' ? getDaysPostOp(lastTreatment) : null
    return { ...p, treatment: lastTreatment, status, days_post_op: days }
  })
